...
class tl_rsz_athletenbiografie extends Backend
{
    ...
    {
        if ('rsz_athletenbiografie' === Input::get('do') && 'downloadRszAthletenbiografie' === Input::get('action')) {
            $blnAllowDownload = false;
            /** @var AttributeBagInterface $objSessionBag */
            $objSessionBag = System::getContainer()->get('session')->getBag('contao_backend');

            if ('rsz_athletenbiografie' === Input::get('do')) {
                $objSessionBag->all();
    ...
    {
        if ('rsz_athletenbiografie' === Input::get('do') && 'downloadAttachment' === Input::get('action') && '' !== Input::get('uuid')) {
